            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-8">
                    <div class="product__details__text">
                        ...
                        <p>Coat with quilted lining and an adjustable hood. Featuring long sleeves
                            with adjustable
                            cuff tabs, adjustable asymmetric hem with elastic side tabs and a front
                            zip fastening
                            with placket.</p>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    ...
                    <p>The customer is at the heart of our unique business model, which includes
                        design.</p>
