...
public class OrderProductManager {
    ...
    public ProductDetailForOrder determineProductDetailForOrder(Long productId, SqlSession session) throws Exception {
    ...
    public void updateStockQuantity(Product product, Long quantity, SqlSession session) throws Exception {
